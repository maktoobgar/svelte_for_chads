...
def main():
    ...
    action(lambda: os.system("npm i") == 0, "Install Requirements")
    ...
    # Build Process
    action(lambda: os.system("npm run build") == 0, "Build Project")

    # Deploy Process
    action(lambda: os.system("docker compose down && docker compose up -d") == 0, "Host Project")
